...
import type { AverageFpsChangedEvent, NativeCameraViewProps, OnCodeScannedEvent, OnErrorEvent } from '../src_bak/NativeCameraView'
import { NativeCameraView } from '../src_bak/NativeCameraView'
