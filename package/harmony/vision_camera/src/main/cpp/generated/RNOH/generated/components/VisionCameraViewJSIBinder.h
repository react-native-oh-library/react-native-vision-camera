...
class VisionCameraViewJSIBinder : public ViewComponentJSIBinder {
  protected:
    facebook::jsi::Object createNativeProps(facebook::jsi::Runtime &rt) override {
        ...
        object.setProperty(rt, "photoAspectRatio", true);
        object.setProperty(rt, "codeScanner", "Object");
        object.setProperty(rt, "fps", true);
        object.setProperty(rt, "isMirrored", true);
        object.setProperty(rt, "videoHdr", true);
        ...
        object.setProperty(rt, "androidPreviewViewType", true);
        object.setProperty(rt, "enableLocation", true);
        object.setProperty(rt, "photoQualityBalance", true);
        return object;
    }
